...
const Addproduct = () => {
  ...
  const [productDetails, setProductDetails] = useState({
    ...
    user: "", // Default value or set based on your app logic
  });
  ...
  return (
      ...
      <div className='add-product'>
        ...
        <div className="addproduct-itemfield">
          <p>Name</p>
          <input value={productDetails.user} onChange={changeHandler} type="text" name="user" placeholder="Name" className="addproduct-input" />
        </div>
        <div className="addproduct-itemfield">
          <p>Shop Name</p>
          <input value={productDetails.name} onChange={changeHandler} type="text" name="name" placeholder="Shop Name" className="addproduct-input" />
        </div>
